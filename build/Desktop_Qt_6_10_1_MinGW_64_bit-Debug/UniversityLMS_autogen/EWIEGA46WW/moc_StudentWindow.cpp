...
template <> constexpr inline auto StudentWindow::qt_create_metaobjectdata<qt_meta_tag_ZN13StudentWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onViewAttendance'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onViewSeatingPlan'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onViewResults'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onViewFeeChallan'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onViewAssignments'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onViewDashboard'
...
void StudentWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onViewAttendance(); break;
        case 1: _t->onViewSeatingPlan(); break;
        case 2: _t->onViewResults(); break;
        case 3: _t->onViewFeeChallan(); break;
        case 4: _t->onViewAssignments(); break;
        case 5: _t->onViewDashboard(); break;
